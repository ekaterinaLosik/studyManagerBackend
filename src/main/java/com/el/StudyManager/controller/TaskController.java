package com.el.StudyManager.controller;
...
import com.el.StudyManager.service.TaskService;
...
public class TaskController {
    ...
    public ResponseEntity<?> addTask(@RequestBody Task taskPara,@PathVariable Long id) {
        if(taskservice.existById(id)) {
            ...
            task.setCourse(taskPara.getCourse());
            task.setBody(taskPara.getBody());
            taskservice.save(task);
            return ResponseEntity.ok().body(task);
        }else {
            HashMap<String, String>message= new HashMap<>();
            message.put("message", id + " The task not found");
    ...
    public ResponseEntity<?> deleteTask(@PathVariable Long id) {
        if(taskservice.existById(id)) {
            ...
            HashMap<String, String>message= new HashMap<>();
            message.put("message", id + " This task has been deleted");
